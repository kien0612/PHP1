                ...
                <div class="main-body">
                    <div class="d-flex justify-content-between align-items-center m-2">
                        ...
                        <button class="btn btn-success justify-content-end btn__add-item" type="button">
                            <a href="admin_productAdd.php">Thêm sản phẩm</a>
                        </button>
                    </div>
                        <?php
                            include_once 'db.php';
                            $sql = "select * from products join product_cate on products.product_cateID=product_cate.product_cateID order by product_id desc";
                            ...
                            <?php
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><img style="width: 100px;" src="asset/images/products/<?php echo $row['product_images']?>" alt=""></td>
                                            <td><?php echo $row['product_price']?></td>
                                            <td><?php echo $row['product_quantity']?></td>
                                            <td>
                                                <span class="d-inline-block text-truncate" style="max-width: 300px;">
                                                    <?php echo $row['product_infor']?></td>
                                                </span>
                                               
                                            <td><?php echo $row['product_cateName']?></td>
                                            <td class="text-right">
                                                <button class="btn btn-warning btn__modify-item" type="submit">
                                                    <a href="admin_productUpdate.php?pro_id=<?php echo $row['product_id']?>">Sửa</a>
                                                </button>
                                                <button class="btn btn-danger btn__delete-item" type="submit">
                                                    <a href="admin_productDelete.php?pro_id=<?php echo $row['product_id']?>">Xóa</a>
                                                </button>
                                            </td>
                                        </tr>
